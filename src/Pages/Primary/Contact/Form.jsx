...
const Form = ({ getSubmissions }) => {
    // NAME
    const [inputName, inputNameUpdate] = useState("Name");
    ...
    // EMAIL
    const [inputEmail, inputEmailUpdate] = useState("name@email.com");
    ...
    // MESSAGE
    const [inputMessage, inputMessageUpdate] = useState("Type Message Here");
